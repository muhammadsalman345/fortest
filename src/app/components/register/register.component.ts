...
//       (error: any) => {
//         if (error.status === 409) {
//           this.messages.push({ severity: 'warn', summary: 'Warning', detail: 'User already registered. Please log in.' });this.loading = false;
//         } else if (error.error && error.error.message) {
//           this.messages.push({ severity: 'error', summary: 'Error', detail: error.error.message });this.loading = false;
//         } else {
//           this.messages.push({ severity: 'error', summary: 'Error', detail: 'Error during registration. Please try again.' });this.loading = false;
//         }
//       },
//       () => {
//          // Set loading to false in the complete callback check
//       }
//     );
// }
